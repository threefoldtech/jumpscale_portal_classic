...
(function(mod) {
  ...
  CodeMirror.prototype = {
    ...
    getTokenAt: function(pos, precise) {
      ...
      // console.log( stream.current(stream.pos -2) );
      return {start: stream.start,
              end: stream.pos,
              string: stream.current(),
              fullString: stream.string,
              type: style || null,
              state: state};
    },
  ...
  StringStream.prototype = {
    ...
    current: function(position){
      // console.log(this.string.slice(this.start, this.pos));
      if(position){
        return this.string.slice(this.start, position);
      }else{
